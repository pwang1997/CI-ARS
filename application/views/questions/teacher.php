...
<?php foreach ($question_list as $question) : ?>
    ...
    foreach ($choices as $choice) : ?>
        <div class="form-group row choice_row">
            ...
            <div class="col-sm-6">
                <input type="text" class="form-control" id="choice<?= $i; ?>" autocomplete="on" placeholder="<?php echo $choice; ?>">
            </div>
            <div class="form-check col-sm-1">
                <input class="form-check-input" type="checkbox" name="choice_row_<?php echo $question['id']; ?>" value="correct" 
