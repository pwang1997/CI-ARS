        ...
        <div class="row">
            ...
            <div class="col-4">
                ...
                <div class="d-flex flex-column">
                    ...
                    <div class="p-2">
                        <div class="form-group">
                            <input type="text" class="form-control" id="category_<?php echo $question['id'];; ?>" value="<?php echo $question['category']; ?>">
                            <small class="form-text text-muted">category</small>
                        </div>
                    </div>
                    <div class="p-2">
                        <div class="form-group">
                            <input type="text" class="form-control" id="duration_<?php echo $question['id']; ?>" value="<?php echo $question['duration']; ?> s">
