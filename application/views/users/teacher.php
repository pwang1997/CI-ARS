...
?>
    <div class="row">
      <?php addedCard($course_list[$i]['course_name'], $course_list[$i]['id']); ?>
...
<?php
function addedCard($course_name, $course_id)
{
  echo ' <div class="card text-white bg-primary mb-3 col-md-3">
        <div class="card-header">' . $course_name . '</div>
        <div class="card-body">
          <h4 class="card-title"><a href="../courses/get_course/' . $course_id . '" class="text-secondary">Section' . $course_id . '</a></h4>
        </div>
      </div>';
}
?>